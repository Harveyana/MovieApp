<template>
    <q-img class="q-ma-md rounded-borders col-3" :src="props.Poster" placeholder-src="/right-arrow.png" :ratio="1" :class="{mobileview: breakpoint < 760, desktopview: breakpoint > 760}">
